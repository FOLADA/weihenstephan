...
import sarajishviliXOImg from '@/assets/MenuImages/სარაჯიშვილიXO.jpg';
...
import georgianWalnutsImg from '@/assets/MenuImages/ქართულითხილი.png';
...
import kanchiPlatterImg from '@/assets/MenuImages/კანჭი (4 პერსონა) (შებრაწული კანჭი, სარდელი, სოსისი, კარტოფილი მექსიკურად, მწნილი, სოუსი, მწვანე სალათი).avif';
...
import lobioPlatter4PersonsImg from '@/assets/MenuImages/ლობიოს დაფა (4 პერსონა) (მწნილისა და მწვანილის ნაირსახეობა, მჭადი).avif';
...
import beerPlatterImg from '@/assets/MenuImages/ლუდის დაფა (სიომგის, სულგუნისა და ძეხვის ჩხირები, მოცარელა გახვეული ბეკონში, ნივრიანი პური, სოუსი).avif';
...
import asianSoupImg from '@/assets/MenuImages/სუპი აზიურად (რვაფეხა, კრევეტები, მიდიები, კალმარის რგოლები).avif';
import ukhaWithSalmonImg from '@/assets/MenuImages/უხა სიომგით.avif';
